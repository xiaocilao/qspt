...
import com.zxkj.hc.qspt.orm.hcqspt.bean.mapper.FlowDataMapper;
...
public class FlowDataEntity extends EntityBean<FlowDataEntity,FlowDataDto,FlowDataMapper>{
	...
	@SetuDescription(describe="流程信息ID")
	private String infoId;

	@Column(name="key_name",length=50,nullable=false,columnDefinition="varchar")
	@SetuDescription(describe="")
	private String keyName;

	@Column(name="key_value",length=50,nullable=false,columnDefinition="varchar")
	@SetuDescription(describe="")
