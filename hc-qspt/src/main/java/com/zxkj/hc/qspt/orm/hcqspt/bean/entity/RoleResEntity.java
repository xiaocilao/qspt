...
import com.zxkj.hc.qspt.orm.hcqspt.bean.mapper.RoleResMapper;
import com.zxkj.hc.qspt.setu.system.DbConnStructure;
import com.zxkj.hc.qspt.orm.hcqspt.bean.dto.RoleResDto;
...
public class RoleResEntity extends EntityBean<RoleResEntity,RoleResDto,RoleResMapper>{
	...
	@Column(name="res_id",length=32,nullable=false,columnDefinition="varchar")
	@SetuDescription(describe="")
