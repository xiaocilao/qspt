 ...
 * @author: hfl 
 */
public class FlowDataDto extends BaseDto<FlowDataEntity>{
	...
	public static final String TABLE_NAME= "flow_data";
	...
	public static final String KEY_NAME_D = "key_name";
	public static final String KEY_NAME_J = "keyName";
	public static final Column KEY_NAME_C= new Column(KEY_NAME_D);

	public static final String KEY_VALUE_D = "key_value";
	public static final String KEY_VALUE_J = "keyValue";
	public static final Column KEY_VALUE_C= new Column(KEY_VALUE_D);
