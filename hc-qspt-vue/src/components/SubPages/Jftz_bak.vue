<template>
    <div>
        <image :src='toperimg' class='toperimg'></image>
...
//             var that = this;
//             wx.request({
//                 url: url + "/qishui/qsapp/api/apply/sqsdyj",
//                 method: "GET",
//                 header: commonJs.getHeader(that.getClientKey.clientKey),
//                 data:{
...
//               this.$router.push({
//                        path: path,
//                        query:{applyId:applyId,clientKey:that.getClientKey.clientKey}
//                     });
//             // wx.redirectTo({
